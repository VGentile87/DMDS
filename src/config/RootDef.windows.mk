...
!IF [ %DM_ROOT%\win32\tools\rootversioncode.cmd ] <= 331264        #ROOTSYS <= 5.14.00
LDFLAGS       = $(LDOPT) $(conlflags) -nologo
!ELSE IF [ %DM_ROOT%\win32\tools\rootversioncode.cmd ] < 333062    #ROOTSYS <  5.21.06
...
!ENDIF  
                ...
                libPostscript.lib libMatrix.lib libPhysics.lib libASImage.lib
#
